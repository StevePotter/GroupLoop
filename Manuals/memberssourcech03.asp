...
<p class=Title align=center>CHAPTER <%=intChapter%>: NAVIGATING YOUR SITE</p>
...
down the right wall, and the footer runs along the page floor.
	...
	site items.  A short explanation of each section was given in <a href="ch02.asp?#2">Chapter 2</a>, but 
	you will learn much more about the individual items and sections later on in this manual.
	</p>
...
section.  Before reading post, you will have to know how to find it. 
