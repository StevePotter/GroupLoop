...
<a name="1"></a>
<p align=left class=BodyText><span class=Heading><%=intChapter%>.1 QUIZZES AND YOU: </span>&nbsp;
Quizzes are great way to inject a refreshing brand of comedy and conversation into your site.  This type of addition 
changes the pace of your site by using a new exciting format unlike the standard site additions.</p>
	...
	quizzes.  So if the option isn't there, we didn't do it.
	</p>
...
the quiz.
	...
	<blockquote>
		...
		Using the links, reload either the quiz list or the member menu.
