...
results are retabulated and a graph of the new percentages is created.  Each voting poll has six properties:
	...
	<br>
	<b><i>Vote Limit: </i></b>
	This decides how many times a site-goer can vote in a poll.  For instance, the administrator can make it so each 
...
the picture.).
	...
	<blockquote>
		...
		<br>
		<b><i>4 <%PrintSymb "Confirmation", "poll has been added.gif"%>: </i></b> 
		Using the supplied links, either add more options to the poll, add another, or return to the main administrator page.
		<br><br>
	...
	<blockquote>
		...
		Using the links, reload either the voting poll list or the admin menu.
	...
	several polls going at once, we devoted an entire administrator option to closing opened polls:
