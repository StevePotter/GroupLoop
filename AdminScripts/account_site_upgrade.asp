...
<!-- #include file="..\homegroup\functions.asp" -->

<p align="center"><span class=Heading>Upgrade To Gold Version</span><br>
...
With Command
	...
	if strVersion = "Gold" then
		Set Command = Nothing
		Redirect("error.asp?Message=" & Server.URLEncode("You already have the Gold Version."))
	end if
End With
...
if strSubmit = "Upgrade" then
	...
	objAuthorize.CustomerID = intCustomerID
	objAuthorize.InvoiceNumber = intCustomerID
...
%>
	...
	<p>
	Your site has been upgraded to the Gold Version!  <a href="http://www.GroupLoop.com/<%=strSubDir%>/write_header_footer.asp">Click here</a> to return to your site.  Thanks!
	</p>
<%
'-----------------------Begin Code---------------------------
else
%>
	...
	<form METHOD="POST" ACTION="account_site_upgrade.asp" name="Signup" onsubmit="if (this.submitted) return false; this.submitted = submit_page(this); return this.submitted">
